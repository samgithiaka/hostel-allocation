<?php
 ...
 if ( isset($_POST['btn-signup']) ) {
  ...
  $admin_no = strip_tags($Admission_no);
  $admin_no = htmlspecialchars($Admission_no);
 ...
 /* if (empty($admin_no)) {
  ...
  if( !$error ) {
   ...
   $query = "INSERT INTO users(userName,Admission_no,userEmail,userPass) VALUES('$name','$admin_no','$email','$password')";
...
<label>
             ...
             <div class="input-group">
                <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
             <input type="text" name="admin_no" class="form-control" placeholder="Enter Admission number" maxlength="50" value="<?php echo $admin_no ?>" />
                </div>
